...
static const int SPR_AIRPORT_FENCE_Y_L = 1;
static const int SPR_AIRPORT_FENCE_Y_R = 16;
static const int SPR_AIRPORT_FENCE_X_L = 1;
static const int SPR_AIRPORT_FENCE_X_R = 16;

// Construct all possible fence combinations.
static const DrawTileSeqStruct _station_display_fence_nw_full[] = { TILE_SEQ_LINE(0,  1,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) };
static const DrawTileSeqStruct _station_display_fence_nw_shortw[] = { TILE_SEQ_LINE(1,  1,  0, 15,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) };
static const DrawTileSeqStruct _station_display_fence_nw_shortn[] = { TILE_SEQ_LINE(0,  1,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) };
...
static const DrawTileSeqStruct _station_display_fence_nw[] = {
	TILE_SEQ_LINE(-1,  SPR_AIRPORT_FENCE_X_L,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fence nw
	TILE_SEQ_END()
};
...
static const DrawTileSeqStruct _station_display_fence_sw[] = {
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_R,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR)) // fences sw
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_fence_se[] = {
	TILE_SEQ_LINE(-1, SPR_AIRPORT_FENCE_X_R,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fences se
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_terminal_a[] = {
	TILE_SEQ_LINE_PAL(2,  0,  0, 11, 16, 40, SPR_AIRPORT_TERMINAL_A | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_tower_fence_sw[] = {
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 10, 60, SPR_AIRPORT_TOWER | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_R,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR)) // fences sw
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_concourse[] = {
	TILE_SEQ_LINE_PAL(0,  1,  0, 14, 14, 30, SPR_AIRPORT_CONCOURSE | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_datas_terminal_b[] = {
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 11, 35, SPR_AIRPORT_TERMINAL_B | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_datas_terminal_b_fence_nw[] = {
	TILE_SEQ_LINE(0,  SPR_AIRPORT_FENCE_X_L,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fences left
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 11, 35, SPR_AIRPORT_TERMINAL_B | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_datas_terminal_b_fence_sw[] = {
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 11, 35, SPR_AIRPORT_TERMINAL_B | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_R,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR)) // fences sw
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_datas_terminal_b_fence_se[] = {
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 11, 35, SPR_AIRPORT_TERMINAL_B | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_LINE(-1, SPR_AIRPORT_FENCE_X_R,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fences se
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_datas_terminal_b_fence_se_sw[] = {
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_R,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR)) // fences sw
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 11, 35, SPR_AIRPORT_TERMINAL_B | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_LINE(-1, SPR_AIRPORT_FENCE_X_R,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fences se
	TILE_SEQ_END()
...
static const DrawTileSeqStruct _station_display_datas_terminal_b_fence_ne[] = {
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))  // fence ne
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 11, 35, SPR_AIRPORT_TERMINAL_B | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_datas_terminal_b_fence_ne_se[] = {
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))  // fence ne
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 11, 35, SPR_AIRPORT_TERMINAL_B | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_LINE(-1, SPR_AIRPORT_FENCE_X_R,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fences se
	TILE_SEQ_END()
...
static const DrawTileSeqStruct _station_display_datas_terminal_b_fence_ne_nw[] = {
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))  // fence ne
	TILE_SEQ_LINE(-1,  SPR_AIRPORT_FENCE_X_L,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fence nw
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 11, 35, SPR_AIRPORT_TERMINAL_B | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_END()
...
static const DrawTileSeqStruct _station_display_datas_terminal_b_fence_nw_sw[] = {
	TILE_SEQ_LINE(-1,  SPR_AIRPORT_FENCE_X_L,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fence nw
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 11, 35, SPR_AIRPORT_TERMINAL_B | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_R,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR)) // fences sw
	TILE_SEQ_END()
...
static const DrawTileSeqStruct _station_display_datas_terminal_c[] = {
	TILE_SEQ_LINE_PAL(0,  3,  0, 16, 11, 40, SPR_AIRPORT_TERMINAL_C | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_datas_terminal_c_fence_ne[] = {
	TILE_SEQ_LINE_PAL(0,  3,  0, 16, 11, 40, SPR_AIRPORT_TERMINAL_C | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))  // fence ne
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_datas_terminal_c_fence_nw[] = {
	TILE_SEQ_LINE(-1,  SPR_AIRPORT_FENCE_X_L,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fence nw
	TILE_SEQ_LINE_PAL(0,  3,  0, 16, 11, 40, SPR_AIRPORT_TERMINAL_C | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_datas_terminal_c_fence_se[] = {
	TILE_SEQ_LINE_PAL(0,  3,  0, 16, 11, 40, SPR_AIRPORT_TERMINAL_C | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_LINE(-1, SPR_AIRPORT_FENCE_X_R,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fences se
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_datas_terminal_c_fence_sw[] = {
	TILE_SEQ_LINE_PAL(0,  3,  0, 16, 11, 40, SPR_AIRPORT_TERMINAL_C | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_R,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR)) // fences sw
	TILE_SEQ_END()
};
...
static const DrawTileSeqStruct _station_display_hangar_se[] = {
	TILE_SEQ_LINE_PAL(14,  0,  0,  2, 17, 28, SPR_AIRPORT_HANGAR_FRONT | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_LINE_PAL(0,  0,  0,  2, 17, 28, SPR_AIRPORT_HANGAR_REAR | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_jetway_1[] = {
	TILE_SEQ_LINE_PAL(7, 11,  0,  3,  3, 14, SPR_AIRPORT_JETWAY_1 | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_LINE(0,  SPR_AIRPORT_FENCE_X_L,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR))
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_jetway_2[] = {
	TILE_SEQ_LINE_PAL(2,  7,  0,  3,  3, 14, SPR_AIRPORT_JETWAY_2 | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_jetway_3[] = {
	TILE_SEQ_LINE_PAL(3,  2,  0,  3,  3, 14, SPR_AIRPORT_JETWAY_3 | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_passenger_tunnel[] = {
	TILE_SEQ_LINE_PAL(0,  8,  0, 14,  3, 14, SPR_AIRPORT_PASSENGER_TUNNEL | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_END()
};
...
static const DrawTileSeqStruct _station_display_transmitter_fence_ne_nw[] = {
	TILE_SEQ_LINE(-1,  SPR_AIRPORT_FENCE_X_L,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fence nw
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))  // fence ne
	TILE_SEQ_LINE(7,  7,  0,  2,  2, 70, SPR_TRANSMITTER)
	TILE_SEQ_END()
...
static const DrawTileSeqStruct _station_display_transmitter_fence_ne_se[] = {
	TILE_SEQ_LINE(7,  7,  0,  2,  2, 70, SPR_TRANSMITTER)
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))  // fence ne
	TILE_SEQ_LINE(-1, SPR_AIRPORT_FENCE_X_R,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fences se
	TILE_SEQ_END()
...
static const DrawTileSeqStruct _station_display_transmitter_fence_se_sw[] = {
	TILE_SEQ_LINE(7,  7,  0,  2,  2, 70, SPR_TRANSMITTER)
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_R,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR)) // fences sw
	TILE_SEQ_LINE(-1, SPR_AIRPORT_FENCE_X_R,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fences se
	TILE_SEQ_END()
...
static const DrawTileSeqStruct _station_display_transmitter_fence_se[] = {
	TILE_SEQ_LINE(7,  7,  0,  2,  2, 70, SPR_TRANSMITTER)
	TILE_SEQ_LINE(-1, SPR_AIRPORT_FENCE_X_R,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fences se
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_transmitter_fence_sw[] = {
	TILE_SEQ_LINE(7,  7,  0,  2,  2, 70, SPR_TRANSMITTER)
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_R,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR)) // fences sw
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_transmitter_fence_nw_sw[] = {
	TILE_SEQ_LINE(-1,  SPR_AIRPORT_FENCE_X_L,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fence nw
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_R,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR)) // fences sw
	TILE_SEQ_LINE(7,  7,  0,  2,  2, 70, SPR_TRANSMITTER)
	TILE_SEQ_END()
...
static const DrawTileSeqStruct _station_display_transmitter_fence_nw[] = {
	TILE_SEQ_LINE(-1,  SPR_AIRPORT_FENCE_X_L,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fence nw
	TILE_SEQ_LINE(7,  7,  0,  2,  2, 70, SPR_TRANSMITTER)
	TILE_SEQ_END()
};
...
static const DrawTileSeqStruct _station_display_flag_2_fence_ne[] = {
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))  // fence ne
	TILE_SEQ_LINE(-3, 11,  0,  1,  1, 20, SPR_AIRFIELD_WIND_2 | (1U << PALETTE_MODIFIER_COLOUR))  //ZBase
	//TILE_SEQ_LINE( 5, 11,  0,  1,  1, 20, SPR_AIRFIELD_WIND_2 | (1U << PALETTE_MODIFIER_COLOUR))   //OpenGFX
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_flag_3_fence_ne[] = {
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))  // fence ne
	TILE_SEQ_LINE(-3, 11,  0,  1,  1, 20, SPR_AIRFIELD_WIND_3 | (1U << PALETTE_MODIFIER_COLOUR))  //ZBase
	//TILE_SEQ_LINE( 5, 11,  0,  1,  1, 20, SPR_AIRFIELD_WIND_3 | (1U << PALETTE_MODIFIER_COLOUR))   //OpenGFX
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_flag_4_fence_ne[] = {
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))  // fence ne
	TILE_SEQ_LINE(-3, 11,  0,  1,  1, 20, SPR_AIRFIELD_WIND_4 | (1U << PALETTE_MODIFIER_COLOUR))  //ZBase
	//TILE_SEQ_LINE( 5, 11,  0,  1,  1, 20, SPR_AIRFIELD_WIND_4 | (1U << PALETTE_MODIFIER_COLOUR))   //OpenGFX
	TILE_SEQ_END()
};
...
/* control tower fence ne nw */
static const DrawTileSeqStruct _station_display_tower_ne_nw[] = {
	TILE_SEQ_LINE(-1,  SPR_AIRPORT_FENCE_X_L,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fence nw
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))  // fence ne
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 10, 60, SPR_AIRPORT_TOWER | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_END()
...
/* control tower fence ne se */
static const DrawTileSeqStruct _station_display_tower_ne_se[] = {
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))  // fence ne
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 10, 60, SPR_AIRPORT_TOWER | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_LINE(-1, SPR_AIRPORT_FENCE_X_R,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fences se
	TILE_SEQ_END()
...
/* control tower fence se */
static const DrawTileSeqStruct _station_display_tower_se[] = {
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 10, 60, SPR_AIRPORT_TOWER | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_LINE(-1, SPR_AIRPORT_FENCE_X_R,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fences se
	TILE_SEQ_END()
};

/* control tower fence se sw */
static const DrawTileSeqStruct _station_display_tower_se_sw[] = {
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_R,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR)) // fences sw
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 10, 60, SPR_AIRPORT_TOWER | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_LINE(-1, SPR_AIRPORT_FENCE_X_R,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fences se
	TILE_SEQ_END()
...
/* control tower fence sw */
static const DrawTileSeqStruct _station_display_tower_sw[] = {
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_R,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR)) // fences sw
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 10, 60, SPR_AIRPORT_TOWER | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_END()
};

/* control tower fence ne */
static const DrawTileSeqStruct _station_display_tower_ne[] = {
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))  // fence ne
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 10, 60, SPR_AIRPORT_TOWER | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_END()
};

/* control tower fence nw */
static const DrawTileSeqStruct _station_display_tower_nw[] = {
	TILE_SEQ_LINE(-1,  SPR_AIRPORT_FENCE_X_L,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fence nw
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 10, 60, SPR_AIRPORT_TOWER | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_END()
};

/* control tower fence nw sw */
static const DrawTileSeqStruct _station_display_tower_nw_sw[] = {
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_R,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR)) // fences sw
	TILE_SEQ_LINE(-1,  SPR_AIRPORT_FENCE_X_L,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fence nw
	TILE_SEQ_LINE_PAL(3,  3,  0, 10, 10, 60, SPR_AIRPORT_TOWER | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_END()
...
static const DrawTileSeqStruct _station_display_radar_1_fence_ne[] = {
	...
	TILE_SEQ_GROUND(7,  7,  0,  SPR_AIRPORT_RADAR_1)
	//TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))
	TILE_SEQ_END()
};

static const DrawTileSeqStruct _station_display_radar_2_fence_ne[] = {
	TILE_SEQ_GROUND(7,  7,  0,  SPR_AIRPORT_RADAR_2)
	//TILE_SEQ_LINE(7,  7,  0,  2,  2,  8, SPR_AIRPORT_RADAR_2)
	//TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))
	TILE_SEQ_END()
};
...
static const DrawTileSeqStruct _station_display_radar_3_fence_ne[] = {
	TILE_SEQ_GROUND(7,  7,  0,  SPR_AIRPORT_RADAR_3)
	//TILE_SEQ_LINE(7,  7,  0,  2,  2,  8, SPR_AIRPORT_RADAR_3)
	//TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))
	TILE_SEQ_END()
};
...
/* helipad for continental airport */
static const DrawTileSeqStruct _station_display_helipad_fence_ne[] = {
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))  // fence ne
	TILE_SEQ_LINE(0,  1,  2,  0,  0,  0, SPR_NEWHELIPAD)
	TILE_SEQ_END()
};
...
static const DrawTileSeqStruct _station_display_fence_ne_sw[] = {
	TILE_SEQ_GROUND(SPR_AIRPORT_FENCE_Y_L,  0,  0,  SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_R,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR)) // fences sw
	TILE_SEQ_END()
};
...
/* runway tiles with 2 corner fences */
static const DrawTileSeqStruct _station_display_fence_se_sw_nw[] = {
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_R,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR)) // fences sw
	TILE_SEQ_LINE(-1, SPR_AIRPORT_FENCE_X_R,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fences se
	TILE_SEQ_LINE(-1,  SPR_AIRPORT_FENCE_X_L,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fence nw
	TILE_SEQ_END()
...
/* runway tiles with 2 corner fences */
static const DrawTileSeqStruct _station_display_fence_se_nw[] = {
	TILE_SEQ_LINE(-1, SPR_AIRPORT_FENCE_X_R,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fences se
	TILE_SEQ_LINE(-1,  SPR_AIRPORT_FENCE_X_L,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fence nw
	TILE_SEQ_END()
};
...
/* runway tiles with 3 corner fences */
...
/* helipad tiles with 2 corner fences */
static const DrawTileSeqStruct _station_display_helipad_fence_NE_NW[] = {
	TILE_SEQ_LINE(-1,  SPR_AIRPORT_FENCE_X_L,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fence nw
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))  // fence ne
	TILE_SEQ_LINE(0,  1,  2,  0,  0,  0, SPR_NEWHELIPAD)
	TILE_SEQ_END()
...
static const DrawTileSeqStruct _station_display_low_building_fence_ne_nw[] = {
	TILE_SEQ_LINE(-1,  SPR_AIRPORT_FENCE_X_L,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fence nw
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))  // fence ne
	TILE_SEQ_LINE_PAL(2,  0,  0, 10, 10, 60, SPR_AIRPORT_HELIDEPOT_OFFICE | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)  // helidepot office
	TILE_SEQ_END()
};

/* helidepot office with fences top + left */
static const DrawTileSeqStruct _station_display_low_building_fence_nw_sw[] = {
	TILE_SEQ_LINE(-1,  SPR_AIRPORT_FENCE_X_L,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fence nw
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_R,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR)) // fences sw
	TILE_SEQ_LINE_PAL(2,  0,  0, 10, 10, 60, SPR_AIRPORT_HELIDEPOT_OFFICE | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)  // helidepot office
	TILE_SEQ_END()
...
static const DrawTileSeqStruct _station_display_hangar_sw[] = {
	TILE_SEQ_LINE_PAL(0,  0,  0,  2, 17, 28, SPR_NEWHANGAR_W_WALL | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)
	TILE_SEQ_LINE_PAL(0,  0,  0,  2, 17, 28, SPR_NEWHANGAR_W | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)  //ZBase
	//TILE_SEQ_LINE_PAL( 13, -1,  0,  2, 17, 28, SPR_NEWHANGAR_W | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)  // OpenGFX
	TILE_SEQ_END()
};

/* North facing hangar */
static const DrawTileSeqStruct _station_display_hangar_nw[] = {
	TILE_SEQ_LINE_PAL(0,  0,  0,  2, 16, 28, SPR_NEWHANGAR_N | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY) //ZBase
	//TILE_SEQ_LINE_PAL( 13, -1,  0,  2, 16, 28, SPR_NEWHANGAR_N | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY) //OpenGFX
	TILE_SEQ_END()
};

/* East facing hangar */
static const DrawTileSeqStruct _station_display_hangar_ne[] = {
	TILE_SEQ_LINE_PAL(0,  0,  0,  2, 16, 28, SPR_NEWHANGAR_E | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)  //ZBase
	//TILE_SEQ_LINE_PAL(  13, -1,  0,  2, 16, 28, SPR_NEWHANGAR_E | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)  //OpenGFX
	TILE_SEQ_END()
};
...
/* helidepot office with fence east */
static const DrawTileSeqStruct _station_display_low_building_fence_ne_se[] = {
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_L,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR))  // fence ne
	TILE_SEQ_LINE(-1, SPR_AIRPORT_FENCE_X_R,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fences se
	TILE_SEQ_LINE_PAL(2,  0,  0, 10, 10, 60, SPR_AIRPORT_HELIDEPOT_OFFICE | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)  // helidepot office
	TILE_SEQ_END()
...
/* helidepot office with fence south */
static const DrawTileSeqStruct _station_display_low_building_fence_se_sw[] = {
	TILE_SEQ_LINE(SPR_AIRPORT_FENCE_Y_R,  0,  0,  1, 16,  6, SPR_AIRPORT_FENCE_Y | (1U << PALETTE_MODIFIER_COLOUR)) // fences sw
	TILE_SEQ_LINE(-1, SPR_AIRPORT_FENCE_X_R,  0, 16,  1,  6, SPR_AIRPORT_FENCE_X | (1U << PALETTE_MODIFIER_COLOUR)) // fences se
	TILE_SEQ_LINE_PAL(2,  0,  0, 10, 10, 60, SPR_AIRPORT_HELIDEPOT_OFFICE | (1U << PALETTE_MODIFIER_COLOUR), PALETTE_TO_GREY)  // helidepot office
	TILE_SEQ_END()
...
static const DrawTileSprites _station_display_datas_airport[] = {
	...
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),     _station_display_nothing)  // APT_STAND
	...
	TILE_SPRITE_LINE(SPR_FLAT_GRASS_TILE,            _station_display_tower_fence_sw) // APT_TOWER_GRASS_FENCE_SW
	...
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),     _station_display_jetway_1)  // APT_STAND_1
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),     _station_display_jetway_2)  // APT_STAND_PIER_NE
	...
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_helipad_fence_sw) // APT_HELIPAD_1
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_helipad_fence_nw) // APT_HELIPAD_2_FENCE_NW
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_helipad)          // APT_HELIPAD_2
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_fence_ne_sw)		// APT_APRON_FENCE_NE_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_RUNWAY_EXIT_B,      _station_display_fence_se_nw)		// APT_RUNWAY_FENCE_NW_SE
	...
	TILE_SPRITE_LINE(SPR_AIRPORT_RUNWAY_END,         _station_display_fence_se_sw_nw)	// APT_RUNWAY_END_FENCE_SE_SW_NW
	TILE_SPRITE_LINE(SPR_AIRPORT_RUNWAY_END,         _station_display_fence_ne)			// APT_RUNWAY_END_FENCE_NE
	TILE_SPRITE_LINE(SPR_AIRPORT_RUNWAY_END,         _station_display_fence_ne_nw)		// APT_RUNWAY_END_FENCE_NE_NW
	TILE_SPRITE_LINE(SPR_AIRPORT_RUNWAY_END,         _station_display_fence_ne_nw_se)	// APT_RUNWAY_END_FENCE_NE_NW_SE
	...
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_helipad_fence_NE_SE)	// APT_HELIPAD_2_FENCE_NE_SE
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_helipad_fence_NE_NW)	// APT_HELIPAD_2_FENCE_NE_NW
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_helipad_fence_NW_SW)	// APT_HELIPAD_2_FENCE_NW_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_helipad_fence_SE)		// APT_HELIPAD_2_FENCE_SE
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_helipad_fence_SE_SW)	// APT_HELIPAD_2_FENCE_SE_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_helipad_fence_SW)		// APT_HELIPAD_2_FENCE_SW
	...
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_newhelipad_fence_se_sw) // APT_HELIPAD_3_FENCE_SE_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_newhelipad_fence_nw_sw) // APT_HELIPAD_3_FENCE_NW_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_newhelipad_fence_nw) // APT_HELIPAD_3_FENCE_NW
	...
	//TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND,     _station_display_fence_nw)		// APT_STAND_FENCE_NW
	//TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND,     _station_display_fence_se)		// APT_STAND_FENCE_SE
	//TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND,     _station_display_fence_se_sw)	// APT_STAND_FENCE_SE_SW
	//TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND,     _station_display_fence_sw)		// APT_STAND_FENCE_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_fence_ne)		// APT_STAND_FENCE_NE
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_fence_nw)		// APT_STAND_FENCE_NW
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_fence_se)		// APT_STAND_FENCE_SE
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_fence_se_sw)	// APT_STAND_FENCE_SE_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_fence_sw)		// APT_STAND_FENCE_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_fence_ne_nw) // APT_APRON_FENCE_NE_NW
	TILE_SPRITE_LINE(SPR_AIRPORT_RUNWAY_END,         _station_display_fence_sw) // APT_RUNWAY_END_FENCE_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_datas_terminal_b_fence_nw)	// APT_BUILDING_3_FENCE_NW
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_datas_terminal_b_fence_nw_sw) // APT_BUILDING_3_FENCE_NW_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_datas_terminal_b_fence_ne)	// APT_BUILDING_3_FENCE_NE
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_datas_terminal_b_fence_ne_nw) // APT_BUILDING_3_FENCE_NE_NW
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_datas_terminal_b_fence_ne_se) // APT_BUILDING_3_FENCE_NE_SE
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_datas_terminal_b_fence_se)	// APT_BUILDING_3_FENCE_SE
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_datas_terminal_b_fence_se_sw)	// APT_BUILDING_3_FENCE_SE_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_datas_terminal_b_fence_sw)	// APT_BUILDING_3_FENCE_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_tower_ne_nw)	// APT_TOWER_FENCE_NE_NW
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_tower_ne_se)	// APT_TOWER_FENCE_NE_SE
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_tower_se)		// APT_TOWER_FENCE_SE
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_tower_se_sw)	// APT_TOWER_FENCE_SE_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_tower_sw)		// APT_TOWER_FENCE_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_tower_ne)		// APT_TOWER_FENCE_NE
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_tower_nw)		// APT_TOWER_FENCE_NW
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_tower_nw_sw)	// APT_TOWER_FENCE_NW_SW
	TILE_SPRITE_LINE(SPR_NSRUNWAY_END,               _station_display_nothing) // APT_NSRUNWAY_END
	TILE_SPRITE_LINE(SPR_NSRUNWAY_END,               _station_display_fence_ne_se)		// APT_NSRUNWAY_END_FENCE_NE_SE
	TILE_SPRITE_LINE(SPR_NSRUNWAY_END,               _station_display_fence_ne_se_sw)	// APT_NSRUNWAY_END_FENCE_NE_SE_SW
	TILE_SPRITE_LINE(SPR_NSRUNWAY_END,               _station_display_fence_ne_nw)		// APT_NSRUNWAY_END_FENCE_NE_NW
	TILE_SPRITE_LINE(SPR_NSRUNWAY_END,               _station_display_fence_ne_nw_sw)	// APT_NSRUNWAY_END_FENCE_NE_NW_SW
	TILE_SPRITE_LINE(SPR_NSRUNWAY_END,               _station_display_fence_nw_sw)		// APT_NSRUNWAY_END_FENCE_NW_SW
	TILE_SPRITE_LINE(SPR_NSRUNWAY_END,               _station_display_fence_se_sw)		// APT_NSRUNWAY_END_FENCE_SE_SW
	TILE_SPRITE_LINE(SPR_NSRUNWAY_END,               _station_display_fence_ne)			// APT_NSRUNWAY_END_FENCE_NE
	TILE_SPRITE_LINE(SPR_NSRUNWAY_END,               _station_display_fence_nw)			// APT_NSRUNWAY_END_FENCE_NW
	TILE_SPRITE_LINE(SPR_NSRUNWAY_END,               _station_display_fence_sw)			// APT_NSRUNWAY_END_FENCE_SW
	TILE_SPRITE_LINE(SPR_NSRUNWAY4,                  _station_display_nothing)			// APT_NSRUNWAY
	TILE_SPRITE_LINE(SPR_NSRUNWAY4,                  _station_display_fence_ne)			// APT_NSRUNWAY_FENCE_NE
	TILE_SPRITE_LINE(SPR_NSRUNWAY4,                  _station_display_fence_sw)			// APT_NSRUNWAY_FENCE_SW
	TILE_SPRITE_LINE(SPR_NSRUNWAY4,                  _station_display_fence_ne_sw)		// APT_NSRUNWAY_FENCE_NE_SW
	TILE_SPRITE_LINE(SPR_FLAT_GRASS_TILE,            _station_display_transmitter_fence_ne_nw) //APT_RADIO_TOWER_FENCE_NE_NW
	TILE_SPRITE_LINE(SPR_FLAT_GRASS_TILE,            _station_display_transmitter_fence_ne_se) //APT_RADIO_TOWER_FENCE_NE_SE
	TILE_SPRITE_LINE(SPR_FLAT_GRASS_TILE,            _station_display_transmitter_fence_nw)	   //APT_RADIO_TOWER_FENCE_NW
	TILE_SPRITE_LINE(SPR_FLAT_GRASS_TILE,            _station_display_transmitter_fence_nw_sw) //APT_RADIO_TOWER_FENCE_NW_SW
	TILE_SPRITE_LINE(SPR_FLAT_GRASS_TILE,            _station_display_transmitter_fence_se)    //APT_RADIO_TOWER_FENCE_SE
	TILE_SPRITE_LINE(SPR_FLAT_GRASS_TILE,            _station_display_transmitter_fence_se_sw) //APT_RADIO_TOWER_FENCE_SE_SW
	TILE_SPRITE_LINE(SPR_FLAT_GRASS_TILE,            _station_display_transmitter_fence_sw)    //APT_RADIO_TOWER_FENCE_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_datas_terminal_c_fence_ne) // APT_BUILDING_1_FENCE_NE
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_datas_terminal_c_fence_nw) // APT_BUILDING_1_FENCE_NW
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_datas_terminal_c_fence_se) // APT_BUILDING_1_FENCE_SE
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_datas_terminal_c_fence_sw) // APT_BUILDING_1_FENCE_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_low_building_fence_ne)	// APT_LOW_BUILDING_FENCE_NE
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_low_building_fence_ne_se) // APT_LOW_BUILDING_FENCE_NE_SE
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_low_building_fence_ne_nw) // APT_LOW_BUILDING_FENCE_NE_NW
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_low_building_fence_nw_sw) // APT_LOW_BUILDING_FENCE_NW_SW
	...
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_low_building_fence_se_sw) // APT_LOW_BUILDING_FENCE_SE_SW
	//TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND, _station_display_helipad_fence_ne)  // APT_HELIPAD_2_FENCE_NE
	//TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND, _station_display_fence_ne_nw) //APT_STAND_FENCE_NE_NW
	//TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND, _station_display_fence_ne_se) //APT_STAND_FENCE_NE_SE
	//TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND, _station_display_fence_nw_sw) //APT_STAND_FENCE_NW_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_helipad_fence_ne)  // APT_HELIPAD_2_FENCE_NE
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_fence_ne_nw) //APT_STAND_FENCE_NE_NW
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_fence_ne_se) //APT_STAND_FENCE_NE_SE
	TILE_SPRITE_LINE(SPR_AIRPORT_AIRCRAFT_STAND | (1U << PALETTE_MODIFIER_COLOUR),              _station_display_fence_nw_sw) //APT_STAND_FENCE_NW_SW
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_fence_se_nw) // APT_APRON_FENCE_SE_NW
	TILE_SPRITE_LINE(SPR_AIRPORT_APRON,              _station_display_fence_nw_sw) // APT_APRON_FENCE_NW_SW
	TILE_SPRITE_LINE(SPR_NSRUNWAY_END,               _station_display_fence_se) // APT_NSRUNWAY_END_FENCE_SE
	TILE_SPRITE_LINE(SPR_AIRPORT_RUNWAY_EXIT_B,      _station_display_fence_se_nw) // APT_RUNWAY_FENCE_SE_NW
};
