...
enum AirportMovementStates {
	...
	CARG09         = 58, ///< Heading for Cargo 08 terminal.
	CARG10         = 59, ///< Heading for Cargo 08 terminal.
	CARG11         = 60, ///< Heading for Cargo 08 terminal.
	CARG12         = 61, ///< Heading for Cargo 08 terminal.
